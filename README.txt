...
Answer: All you need to do is change the statement in the config file is set the configuration option to (true or false). For example if you set the "set_items" option to "true" it will only snipe the items in the custom.txt file, then when you set it back to false it will stop.
====
Extra Info
